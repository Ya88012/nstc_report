...
\begin{document}
    ...
    \section{摘要}
        ...
        藉由紐約市公共自行車系統資料，
        建立高效深度學習模型用以預測各站點狀況，
        並實際應用於本地高雄市公共自行車系統以解決各站點車輛不平衡之問題。
    ...
    \section{研究方法}
        ...
        \subsection{One-Shot NAS 及自適應退火基因演算法}
            ...
            {\fontsize{12pt}{10.5pt}\selectfont
                \begin{breakablealgorithm}
                    \caption{ASAGA}\label{alg:ASAGA}
                    \begin{algorithmic}[1]
                        \Require Supernet $S$
    ...
    \section{實驗}
        ...
        \subsection{使用者介面設計}
            ...
            \begin{itemize}
                ...
                \item 非同步請求(asynchronous request) → Ajax、Asynchronous JavaScript與XML： \\
                    Ajax和Asynchronous JavaScript是一個能讓網站能在不用刷新頁面的情況下自動從資料庫抓取資料的一個請求方法(request method)。
